...
{
    public:
    bool helper(Node *root, int& countSingleValued)
    {
        if(root==NULL)
        {
            return true;
        }
        bool left = helper(root->left, countSingleValued);
        bool right = helper(root->right, countSingleValued);
        if(!left || !right)
        {
            return false;
        }
    ...
    int singlevalued(Node *root)
    {
        ...
        helper(root, countSingleValued);
        return countSingleValued;
    }
